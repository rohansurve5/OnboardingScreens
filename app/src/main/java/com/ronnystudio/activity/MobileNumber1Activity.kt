...
class MobileNumber1Activity: AppCompatActivity() {
	...
	companion object {
		...
		fun newIntent(context: Context): Intent {
			...
			return Intent(context, MobileNumber1Activity::class.java)
		}
	}
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		this.setContentView(R.layout.mobile_number1_activity)
		this.init()
	}
	...
	private fun init() {
		...
		continueButton.background = LinearGradientDrawable.Builder(this, PointF(0f, 1f), PointF(0.89f, 0f)).cornerRadius(R.dimen.mobile_number1_activity_continue_button_radius).addStop(0f, Color.argb(255, 126, 241, 146)).addStop(1f, Color.argb(255, 45, 200, 151)).build()
