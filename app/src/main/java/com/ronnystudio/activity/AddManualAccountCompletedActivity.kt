/*
*  AddManualAccountCompletedActivity.kt
*  Onboarding-freebie
*
...
class AddManualAccountCompletedActivity: AppCompatActivity() {
	...
	companion object {
		...
		fun newIntent(context: Context): Intent {
			...
			return Intent(context, AddManualAccountCompletedActivity::class.java)
		}
	}
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		this.setContentView(R.layout.add_manual_account_completed_activity)
		this.init()
	}
	...
	private fun init() {
		...
		// Configure Add account component
		addAccountButton = this.findViewById(R.id.add_account_button)
		addAccountButton.setOnClickListener({ view ->
			this.onAddAccountPressed()
		})
		addAccountButton.background = LinearGradientDrawable.Builder(this, PointF(0f, 1f), PointF(0.89f, 0f)).cornerRadius(R.dimen.add_manual_account_completed_activity_add_account_button_radius).addStop(0f, Color.argb(255, 126, 241, 146)).addStop(1f, Color.argb(255, 45, 200, 151)).build()
	}
