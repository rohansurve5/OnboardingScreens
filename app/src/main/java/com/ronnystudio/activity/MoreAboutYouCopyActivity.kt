...
class MoreAboutYouCopyActivity: AppCompatActivity() {
	...
	companion object {
		...
		fun newIntent(context: Context): Intent {
			...
			return Intent(context, MoreAboutYouCopyActivity::class.java)
		}
	}
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		this.setContentView(R.layout.more_about_you_copy_activity)
		this.init()
	}
	...
	private fun init() {
		...
		continueButton.background = LinearGradientDrawable.Builder(this, PointF(0f, 1f), PointF(0.89f, 0f)).cornerRadius(R.dimen.more_about_you_copy_activity_continue_button_radius).addStop(0f, Color.argb(255, 126, 241, 146)).addStop(1f, Color.argb(255, 45, 200, 151)).build()
